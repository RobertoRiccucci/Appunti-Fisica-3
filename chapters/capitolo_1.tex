...
Nell'espressione di $N_2(t)$ compaiono due esponenziali con andamenti molto diversi. Il termine $e^{-\lambda_2 t}$ si annulla dopo qualche vita media $\tau_2$, mentre su questa scala di tempi $e^{-\lambda_1 t}$ è praticamente costante. Per $t \gg \tau_2$ possiamo quindi trascurare $e^{-\lambda_2 t}$ e si ottiene 
...
Poiché $\lambda_2 \gg \lambda_1$ vale inoltre $\lambda_2 - \lambda_1 \simeq \lambda_2$, per cui 
